...
CYGNUS_INC = -I/usr/include/ -I$(CYGNUS_DIR)/Cygnus/include/ -I$(CYGNUS_DIR)/mthread/include/
CYGNUS_LIB = -L$(CYGNUS_DIR)/mthread -lmthread -L$(CYGNUS_DIR)/Cygnus -lcygnus -L/home/yihan/Hoard/src -lhoard
